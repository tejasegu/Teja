...
public class Assignment3Q10 {
    ...
    public static void main(String[] args) {
    	MovieDetails a= new MovieDetails("Darling","Prabhas","Kajal","Love");
    	MovieDetails b= new MovieDetails("Bahubhali","Prabhas","Kajal","Love");
    	MovieDetails c= new MovieDetails("Sahoo","Prabhas","ttt","Action");
    	MovieDetails d= new MovieDetails("aaaa","bbbb","ttt","Action");
    	MovieDetails add= new MovieDetails("bbbb","no","ttt","Action");
    	...
    	Assignment3Q10 ab=new Assignment3Q10();
    	Assignment3Q10.printSortedMovieList(movies);
    	ab.addMovie(add);
    	System.out.print(ab.find_movie_By_Genre("Action"));
    	System.out.print(ab.find_movie_By_mov_Name("Bahubhali"));
        ab.removeMovies("aaaa");
